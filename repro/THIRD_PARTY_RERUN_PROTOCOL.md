...
3. Confirm that `repro/certificate_runtime.json` reports `LGC_G1` through `LGC_G6` and `LGC_GM` as `PASS`.
...
6. Read `paper/LOCAL_GLOBAL_LANGLANDS_COMPATIBILITY_PREPRINT.md` with the super-repo interpretation in mind.
